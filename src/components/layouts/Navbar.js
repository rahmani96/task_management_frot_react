        ...
        <AppBar position="fixed">
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Typography variant="h6" noWrap component="a" href="/dashboard" sx={{ mr: 2, display: { xs: 'none', md: 'flex' },
                            fontFamily: 'monospace', fontWeight: 700, letterSpacing: '.3rem', color: 'inherit', textDecoration: 'none'}} >
                        DASHBOARD
                    </Typography>
                    <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
                        {/* <Button onClick={() => navigate('/users')} sx={{ my: 2, color: 'white', display: 'block' }} > Manage users </Button> */}
                    </Box>
                    <Box sx={{ flexGrow: 0 }}>
                    <Tooltip>
